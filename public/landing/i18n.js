...
(function () {
  const DICT = {
    en: {
      ...
      'hero.commit': 'commit landed · feat(checkout): coupon field',
      'hero.reading': 'reading change · blast radius', 'hero.writing': 'wrote 4 specs · 2nd model approved',
    ...
    es: {
      'nav.how': 'cómo funciona', 'nav.engine': 'motor en vivo', 'nav.compare': 'comparar', 'nav.cta': 'Correr un escenario',

      'hero.kicker': 'QA E2E autónomo',
      'hero.h1': 'Prueba cada deploy.\nNo confía en ninguno.',
      'hero.sub': 'Cuando un commit entra a tu entorno DEV, panchito lee el cambio, escribe los tests de Playwright para lo que podría romperse, y los corre contra el sitio vivo, antes de que abras el PR.',
      'hero.cta1': 'Correr un escenario', 'hero.cta2': 'Verlo funcionar',
      'hero.m1': 'se dispara al mergear a main', 'hero.m2': 'PRs a tu propio git', 'hero.m3': 'código abierto',
      'hero.commit': 'commit recibido · feat(checkout): campo de cupón',
      'hero.reading': 'leyendo cambio · blast radius', 'hero.writing': 'escribió 4 specs · 2.º modelo aprobó',
      ...
      'd1.capk': 'Por defecto: diff', 'd1.cap': '(blast radius de un cambio). También: manual (probá lo que pidas) · complete (auditar toda la suite).',
      ...
      'd2.sub': 'Escribe el spec, un modelo distinto lo revisa buscando asserts reales, y el change-coverage confirma que el test realmente ejecuta las líneas que cambiaste. Después corre contra tu DEV vivo y te dice, en lenguaje claro, qué se rompió. Verde y aprobado se vuelve un PR a tu repo. Roto se vuelve un GitHub Issue. Tus tests, tu git, sin lock-in.',
      'd2.ending': 'Final:', 'd2.green': 'verde → PR', 'd2.red': 'roto → Issue',
      'd2.rej': 'hace click en el botón pero nunca verifica el resultado', 'd2.appr': 'verifica que el descuento se aplica al total',
      ...
      'd3.tag': 'memoria + chat', 'd3.kicker': 'Preguntale lo que sea',
      'd3.h2': 'Tu suite de tests, ahora algo con lo que podés hablar.',
      'd3.sub': 'panchito recuerda cada corrida: flujos frágiles, selectores flaky, qué los arregló la última vez, y responde desde su memoria. Hablale desde donde ya trabajás: la CLI, Slack o Telegram.',
      'd3.recall': 'recordando corrida #314 desde memoria',
      'd3.t_q': 'panchito ¿por qué falló checkout ayer?',
      'd3.t_a1': 'test de cupón, flaky 3 de 8 corridas. ambigüedad de selector en el botón de pago.',
      ...
      'd3.g_q': 're-corré el test de cupón en staging',
      'd3.g_a': 'Corriendo <code>coupon.spec</code> en staging. Te dejo el veredicto acá mismo.',
      'd3.act1': 'abrir PR', 'd3.act2': 'ver corrida',
      'd3.r1': 'Abriendo PR #214 con el fix del selector. Pido review ahora.',
      'd3.r2': 'Corrida #318: 12 en verde, 1 flaky (en cuarentena). ¿Te paso el trace?',
      'd3.try': 'En vivo · cambiá de canal o tocá una acción.',

      'd4.tag': 'recursivo', 'd4.kicker': 'Se prueba a sí mismo',
      'd4.h2': 'Lo primero que panchito prueba es panchito.',
      'd4.sub': 'Mientras testea tu proyecto, panchito encuentra un bug en su propia suite. Le pasa el fallo a un agente de mantenimiento, que escribe el fix y lo sube a main. El código que se usa a sí mismo para mejorar, cada día. (Como construir git en git.)',
      'd4.qarole': 'testea tu repo',
      'd4.maintrole': 'arregla panchito',
      'd4.pr': 'fix: estabilizar selector flaky en su propia suite',
      'd4.e1': 'testeando your-org/shop en dev',
      'd4.e2': 'corriendo su propia suite e2e',
      ...
      'eng.kicker': 'Motor en vivo', 'eng.h2': 'No nos creas. Corrélo.',
      'eng.sub': 'Apuntalo a un repo, elegí cuán profundo mirar, y mirá todo el pipeline trabajar, en vivo.',
      'eng.repo': 'Repositorio', 'eng.depth': 'Analizar los últimos N commits', 'eng.or': '· o ·',
      'eng.full': 'Análisis completo: auditar todo el repo', 'eng.run': 'Correr pipeline',
      ...
      'eng.idle': 'configurá una corrida y dale play', 'eng.running': 'corriendo…',
      ...
      'cmp.f5': 'Corre vs tu entorno real', 'cmp.f6': 'Preguntale lo que sea + memoria', 'cmp.f7': 'Se mejora solo (se prueba a sí mismo)',
      ...
      'cta.kicker': 'Empezar', 'cta.h2': 'Corrélo en tu repo real.',
      'cta.sub': 'panchito es código abierto. Auto-hospedá el motor, o sumate a la waitlist del beta hosteado.',
      'cta.ph': 'vos@equipo.dev', 'cta.join': 'Sumarme a la waitlist', 'cta.gh': 'Star en GitHub',
